...
console.assert(simplifyPath('/home/') === '/home')
console.assert(simplifyPath('/../') === '/')
console.assert(simplifyPath('/...') === '/...')
console.assert(simplifyPath('/home//foo/') === '/home/foo')
console.assert(simplifyPath('/a/./b/../../c/') === '/c')
console.assert(simplifyPath('/a/../../b/../c//.//') === '/c')
console.assert(simplifyPath('/a//b////c/d//././/..') === '/a/b/c')
